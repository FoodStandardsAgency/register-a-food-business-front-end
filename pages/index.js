...
const Index = (props) => (
    <FsaLayout {...props}>
        ...
        <ContentItem.B_30_15>
            <ContentItem.B_30_15>
                <Paragraph>
                    When you start a new food business or take over an existing
                    business, you must register with your local authority. You
                    should do this at least **28 days** before trading or before
                    food operations start.
                </Paragraph>
            </ContentItem.B_30_15>

            <InsetText className="bold">
                <Paragraph mb={0}>
                    During this registration, you may come across a few
                    specialist terms, which we have described below:
                </Paragraph>
            </InsetText>
            ...
            <ContentItem.B_30_15>
                ...
                <Paragraph mb={0}>
                    The operator is the person, charity or company who makes the
                    decisions about the food business. They decide what it
            ...
            <ContentItem.B_30_15>
                ...
                <Paragraph mb={0}>
                    The establishment is the location or site of your food
                    business. If it is a mobile food business, please use the
                    location where it is normally stored overnight.
                </Paragraph>
            </ContentItem.B_30_15>
            <ContentItem.B_30_15>
                <Heading as="h2" size="MEDIUM" mb={1}>
