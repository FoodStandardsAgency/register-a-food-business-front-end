  ...
  <FsaLayout {...props}>
    ...
    <ContentItem.B_30_15>
      ...
      <Paragraph>
        ...
        ${props.t(
          "is the local authority your registration will be sent to. Is this the correct local authority for your business? If unsure please use this [Food Business Registration link where you can check for your correct local authority](www.gov.uk/food-business-registration) using the location or site of your food business."
        )}`}
      </Paragraph>
    </ContentItem.B_30_15>
    <InsetText>
