...
const OpeningDaysStart = (props) => (
    <FsaLayout {...props}>
        ...
        <form action={props.formAction} method="post">
            ...
            <HiddenTextAccessible
                summaryText={"I don't know what days to select"}
            >
                <Paragraph mb={0}>
                    The food business will have irregular opening days if it
                    isn't open the same days every week. This could include
                    seasonal establishments such as summer ice-cream vendors. It
                    can also include establishments which only open for events
