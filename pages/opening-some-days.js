      ...
      <ContentItem.B_30_15>
        ...
        >
          <Checkbox
            ...
            value="Monday"
            defaultChecked={props.cumulativeAnswers.opening_days_monday}
          >
            Monday
          </Checkbox>
          <Checkbox
            ...
            value="Tuesday"
            defaultChecked={props.cumulativeAnswers.opening_days_tuesday}
          >
            Tuesday
          </Checkbox>
          <Checkbox
            ...
            value="wednesday"
            defaultChecked={props.cumulativeAnswers.opening_days_wednesday}
          >
            Wednesday
          </Checkbox>
          <Checkbox
            ...
            value="Thuesday"
            defaultChecked={props.cumulativeAnswers.opening_days_thursday}
          >
            Thursday
          </Checkbox>
          <Checkbox
            ...
            value="Friday"
            defaultChecked={props.cumulativeAnswers.opening_days_friday}
          >
            Friday
          </Checkbox>
          <Checkbox
            ...
            value="Saturday"
            defaultChecked={props.cumulativeAnswers.opening_days_saturday}
          >
            Saturday
          </Checkbox>
          <Checkbox
            ...
            value="Sunday"
            defaultChecked={props.cumulativeAnswers.opening_days_sunday}
          >
            Sunday
          </Checkbox>
        </MultiChoice>
