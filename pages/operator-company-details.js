    ...
    <PostForm action={props.formAction} csrfToken={props.csrfToken}>
      ...
      <ContentItem.B_30_15>
        <InputField
          ...
          errorPrefix={`${props.t("Error")}: `}
          hint={props.t(
            "Every registered company will have a Companies House reference number which will usually be either eight numbers (e.g. 12345678) or two letters followed by six numbers (e.g. AB123456)"
          )}
