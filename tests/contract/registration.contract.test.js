    ...
    describe("Valid requests", () => {
        describe("given a local council that manages hygiene and standards", () => {
            ...
            it("Should return the same status", async () => {
                ...
                const doubleResponse = await sendRequest(
                    JSON.stringify(validBody)
                );
            ...
            it("should return the same result from res.json()", async () => {
                ...
                expect(
                    typeof realJsonResponse.email_lc.hygieneAndStandards
                        .recipient
                ).toEqual(
                    typeof doubleJsonResponse.email_lc.hygieneAndStandards
                        .recipient
                );
                expect(
        ...
        describe("given a local council that has a separate council for standards", () => {
            ...
            it("should return the same result from res.json()", async () => {
                ...
                expect(
                    typeof realJsonResponse.email_lc.hygiene.recipient
                ).toEqual(typeof doubleJsonResponse.email_lc.hygiene.recipient);
                expect(
                    typeof realJsonResponse.lcConfig.hygiene.local_council
                ).toEqual(
                ...
                expect(
                    ...
                    typeof doubleJsonResponse.lcConfig.hygiene
                        .local_council_email
                );
                expect(
                    typeof realJsonResponse.email_lc.standards.recipient
                ).toEqual(
                ...
                expect(
                    ...
                    typeof doubleJsonResponse.lcConfig.standards.local_council
                );
                expect(
                    typeof realJsonResponse.lcConfig.standards
                        .local_council_email
                ).toEqual(
                    typeof doubleJsonResponse.lcConfig.standards
                        .local_council_email
                );
            });
        });
