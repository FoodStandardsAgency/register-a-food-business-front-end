    ...
    try {
        if (schema[page]) {
            ...
            if (
                ...
                validatorResult.errors = validatorResult.errors.filter(
                    (error) =>
                        Object.keys(answersToValidate).includes(
            ...
            if (
                ...
                result.errors.opening_days_some =
                    errorMessages.opening_days_some;
            }
    ...
    pages.forEach((page) => {
        if (page === "/partner-name") {
            ...
            if (answersToValidate["operator_secondary_number"] == null) {
                Object.assign(
                    result.errors,
                    validate(page, answersToValidate).errors
                );
            ...
            days.forEach((day) => {
                if (
                    cumulativeFullAnswers["opening_days_start"] ===
                        "Every day" ||
