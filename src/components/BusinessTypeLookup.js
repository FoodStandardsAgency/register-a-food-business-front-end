...
const DataListSection = (props) => (
    <div id="dataListSection">
        <Paragraph>
            Search and select the most fitting business type from the
            suggestions
        </Paragraph>
            ...
            <div>
                {this.state && this.state.renderAutoCompleteSection ? (
                    <div id="autocompleteSection">
                        <Paragraph>
                            Search with your own keywords and then select the
                            most fitting business type from the suggestions
                        </Paragraph>
                        <ContentItem.B_30_15>
                            <HintText>
                                For example
