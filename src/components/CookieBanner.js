    ...
    <Banner id="cookieBanner">
        <BannerBody>
            <BannerParagraph mb={2}>
                Register a food business uses a cookie to create the
                registration. We also use optional cookies to analyse how the
                service is performing. We do not share any information with
                advertisers or social media platforms. We do not store any
            ...
            <BannerRow>
                ...
                <BannerActionContainer>
                    <form
                        action="/setcookie/acceptAllCookies/false"
                        method="get"
                    >
                    ...
                    <form
                        action="/setcookie/acceptAllCookies/true"
                        method="get"
                    >
